...
st.title("Datasweeper Sterling integrator By Nisar Ahmed ")
st.write("Transform your files between CVS and Excel formats with built-in data cleaning and visualization creating the project for auarter 3!")
...
if uploaded_files:
    for file in uploaded_files:
        ...
        if st.checkbox(f"Show visualization for {file.name}"):
            st.br_chart(df.select_dtypes(include='number').iloc[:,:2])
